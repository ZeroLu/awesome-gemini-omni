---
title: Google 刚发的 Gemini Omni，真正可怕的不是出片，而是它开始懂怎么改片了
---
...
1. Gemini Omni 真正值得看的，不是一个演示，而是一条能直接开跑的创作工作流
2. Gemini Omni 这次最重要的，不是模型名，是它把视频生成变成了可编辑工作流
3. Google 刚发的 Gemini Omni，真正可怕的不是出片，而是它开始懂怎么改片了

## 备注

- 已加入最近 7 天 AI HOT 相关报道内容
- 已去掉“X 书签”叙事，只保留对读者有用的发布信息和案例
- GIF 案例与 Cyberbara 截图都已内嵌
